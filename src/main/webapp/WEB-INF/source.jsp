            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form id="add-component" action="<c:url value="/admin/${type}/${component.id}/source/new"/>"
                              method="post">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>

                            <h3 class="mb-5">Add new source</h3>
                            ...
                            <div class="mb-3 row">
                                <label for="inputProducer" class="col-sm-3 col-form-label">
                                    Shop title</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" id="inputProducer"
                                           placeholder="shop title" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputModel" class="col-sm-3 col-form-label">
                                    link to component</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="link" id="inputModel"
                                           placeholder="component link" required>
                                </div>
                            </div>
                        </form>
