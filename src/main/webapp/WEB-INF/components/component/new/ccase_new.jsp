            ...
            <div class="col-12">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form id="add-component" action="<c:url value="/admin/case/new"/>" method="post"
                              enctype="multipart/form-data">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>

                            <h3 class="mb-5">Add new computer case</h3>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="producer" id="inputProducer"
                                           placeholder="computer case producer" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="model" id="inputModel"
                                           placeholder="computer case model" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="caseType" id="inputCore"
                                           placeholder="computer case type" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="colour" id="inputCoreNum"
                                           placeholder="computer case colour" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="material" id="inputSocket"
                                           placeholder="computer case material" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="sectionNumber" id="inputCrystalName"
                                           placeholder="computer case section number"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="maxGraphicsCardWidth" id="inputCrystalName5"
                                           placeholder="graphics card max width" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="maxPowerUnitWidth" id="inputCrystalName6"
                                           placeholder="power unit max width" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="height" id="inputCrystalName2"
                                           placeholder="computer case height" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="width" id="inputCrystalName3"
                                           placeholder="computer case width" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="depth" id="inputCrystalName4"
                                           placeholder="computer case depth" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="weight" id="inputCrystalName7"
                                           placeholder="computer case weight" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="price" id="inputPrice"
                                           placeholder="computer case price" step="any"
                                           required>
                                </div>
                            </div>
                            <div class="mb-3">
