            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form id="add-component" action="<c:url value="/admin/graphics_card/${graphics_card.id}/edit"/>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="producer" id="inputProducer"
                                           placeholder="graphics card producer" value="${graphics_card.producer}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="model" id="inputModel" placeholder="graphics card model" value="${graphics_card.model}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="gpuProducer" id="inputCore" placeholder="gpu producer" value="${graphics_card.gpuProducer}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="gpuModel" id="inputCoreNum" placeholder="gpu model" value="${graphics_card.gpuModel}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="gpuInterface" id="inputSocket" placeholder="gpu interface" value="${graphics_card.gpuInterface}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="videoMemory" id="inputCrystalName" placeholder="gpu videomemory" value="${graphics_card.videoMemory}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="videoMemoryType" id="inputThermalPower" placeholder="gpu videomemory type" value="${graphics_card.videoMemoryType}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="recommendedPower" id="inputMinFreq" placeholder="graphics card recommended power" value="${graphics_card.recommendedPower}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="height" id="inputMaxFreq" placeholder="graphics card height" value="${graphics_card.height}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="length" id="inputssMaxFreq" placeholder="graphics card length" value="${graphics_card.length}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputPrice" class="col-sm-3 col-form-label">Price</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="price" id="inputPrice" placeholder="graphics card price" value="${graphics_card.price}">
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <button form="add-component" class="btn btn-primary btn-lg btn-block" type="submit">Edit</button>
