            ...
            <div class="col-12">
                <div class="card shadow-2-strong" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        <form id="add-component" action="<c:url value="/admin/ssd/${ssd.id}/edit"/>" method="post"
                              enctype="multipart/form-data">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>

                            <h3 class="mb-5">Edit ssd</h3>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="producer" id="inputProducer"
                                           placeholder="SSD producer" value="${ssd.producer}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="model" id="inputModel"
                                           placeholder="SSD model" value="${ssd.model}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCore" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.capacity"/></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="capacity" id="inputCore"
                                           placeholder="SSD capacity" value="${ssd.capacity}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCoreNum" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.controller"/></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="controller" id="inputCoreNum"
                                           placeholder="SSD controller" value="${ssd.controller}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputSocket" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.interface"/></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="ssdInterface" id="inputSocket"
                                           placeholder="SSD interface" value="${ssd.ssdInterface}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCrystalName" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.microchip"/></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="microchipType" id="inputCrystalName"
                                           placeholder="SSD microchip" value="${ssd.microchipType}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCrystalName1" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.formfactor"/></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="formFactor" id="inputCrystalName1"
                                           placeholder="SSD microchip" value="${ssd.formFactor}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCrystalName2" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.writingspeed"/></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="writingSpeed" id="inputCrystalName2"
                                           placeholder="SSD writing speed" value="${ssd.writingSpeed}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCrystalName3" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.readingspeed"/></label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="readingSpeed" id="inputCrystalName3"
                                           placeholder="SSD reading speed" value="${ssd.readingSpeed}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputCrystalName4" class="col-sm-3 col-form-label">
                                    <spring:message code="label.ssd.recsource"/></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="recordingResource" id="inputCrystalName4"
                                           placeholder="SSD recording source" value="${ssd.recordingResource}" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="price" id="inputPrice"
                                           placeholder="SSD price" step="any" value="${ssd.price}" required>
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="/admin/ssd/${ssd.id}/source/new"/>" class="btn btn-success">New</a>
                                </td>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${ssd.sources}" var="source">
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/ssd/${ssd.id}/source/${source.id}/delete"
                                              method="post">
                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
