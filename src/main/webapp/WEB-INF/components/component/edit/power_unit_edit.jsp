                    ...
                    <div class="card-body p-5 text-center">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<c:url value="/admin/power_unit/${power_unit.id}/source/new"/>" class="btn btn-success">New</a>
                                </td>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${power_unit.sources}" var="source">
                                <tr>
                                    ...
                                    <td>
                                        <form action="/admin/power_unit/${power_unit.id}/source/${source.id}/delete"
                                              method="post">
                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
