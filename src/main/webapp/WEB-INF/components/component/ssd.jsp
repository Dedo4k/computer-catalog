        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link"
                                        href="<c:url value="/catalog/ssds"/>"><spring:message
                        code="label.components.ssds"/></a></li>
...
<div class="container align-items-center mt-5">
    ...
    <table class="table table-bordered align-middle mt-5">
        ...
        <tr>
            <td><spring:message code="label.ssd.formfactor"/></td>
            <td>${ssd.formFactor}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>${ssd.recordingResource} TBW</td>
        </tr>
        </tbody>
    </table>
...
<div class="container align-items-center mt-5">
    <form action="<c:url value="/catalog/ssd/${ssd.id}/comment"/>" method="post">
    ...
    <c:if test="${!ssd.reviews.isEmpty()}">
        <c:forEach items="${ssd.reviews}" var="review">
            <div class="card mt-1">
                <div class="card-header">
                    <div class="row">
                        <h3 class="col-11">${review.user.firstName} ${review.user.lastName}</h3>
                        <form action="/catalog/ssd/${ssd.id}/comment/${review.id}" method="post"
                              class="col-1">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <sec:authorize access="hasAuthority('ADMIN')">
