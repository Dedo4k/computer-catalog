    ...
    <c:forEach items="${mother_boards}" var="mother_board">
        <div class="row">
            <div class="card m-4">
                <div class="row">
                    <div class="col-3">
                        <img class="card-img-top" src="<c:url value="/img/mother_board.jpg"/>" alt="processor">
                    </div>
                    <div class="col-9">
                        <div class="card-body">
                            <a href="/catalog/mother_board/${mother_board.id}" class="text-decoration-none"><h5 class="card-title">${mother_board.toString()}</h5></a>
