...
insert into component (id, model, producer, price)
values (16, 'MATREXX 55 V3', 'DeepCool', 186.03);
insert into computer_case (case_type, colour, material, section_number, id)
    values ('Mid Tower', 'white/белый', 'metal/метал', 6, 16);

insert into component (id, model, producer, price)
values (17, 'Silent Base 802 Window', 'be quiet!', 474.60);
insert into computer_case (case_type, colour, material, section_number, id)
    values ('Mid Tower', 'black/черный', 'steel/сталь', 6, 17);

insert into component (id, model, producer, price)
values (18, 'N5 MF', 'Zalman', 100.20);
insert into computer_case (case_type, colour, material, section_number, id)
    values ('Mid Tower', 'black/черный', 'plastic/пластик', 5, 18);

insert into component (id, model, producer, price)
values (19, 'FireBase X2', '1stPlayer', 94.99);
insert into computer_case (case_type, colour, material, section_number, id)
    values ('Mid Tower', 'black/черный', 'steel/сталь', 7, 19);

insert into component (id, model, producer, price)
values (20, 'i3', 'Zalman', 139.28);
insert into computer_case (case_type, colour, material, section_number, id)
    values ('Mid Tower', 'black/черный', 'steel/сталь', 5, 20);
